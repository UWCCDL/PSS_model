...
(defparameter *params* '((:alpha . 0.007) (:EGS . 0.1)))
(with-open-file (out "sims-d1-d2-alpha-0.007-egs-0.1-block%02d-comp.txt" :direction :output 
...
if __name__ == "__main__":
    ...
    for b1 in blocks:
        for b2 in blocks:
            fout = open("sims-d1-d2-alpha-0.007-egs-0.1-block%02d-comp.lisp" % i, 'w')
